...
- [Aggregations By Example](examples/examples.md)
    ...
    - [Securing Data Examples](examples/securing-data/securing-data.md)
        - [Redacted View](examples/securing-data/redacted-view.md)
        - [Mask Sensitive Fields](examples/securing-data/mask-sensitive-fields.md)
        - [Role Programmatic Restricted View](examples/securing-data/role-programmatic-restricted-view.md)
    - [Time-Series Examples](examples/time-series/time-series.md)
        ...
        - [State Change Boundaries](examples/time-series/state-change-boundaries.md)                      
    - [Array Manipulation Examples](examples/array-manipulations/array-manipulations.md)
        ...
        - [Array Fields Joining](examples/array-manipulations/array-fields-joining.md)
