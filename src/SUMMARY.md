...
- [Aggregations By Example](examples/examples.md)
    - [Foundational Examples](examples/foundational/foundational.md)
    ...
    - [Trend Analysis Examples](examples/trend-analysis/trend-analysis.md)
        ...
        - [Largest Graph Network](examples/trend-analysis/largest-graph-network.md)    
        - [Incremental Analytics](examples/trend-analysis/incremental-analytics.md)    
